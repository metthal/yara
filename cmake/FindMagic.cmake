...
if(MAGIC_INCLUDE_DIR AND MAGIC_LIBRARIES)
    ...
    if(NOT TARGET Magic)
        add_library(Magic UNKNOWN IMPORTED)
        set_target_properties(Magic PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${MAGIC_INCLUDE_DIR}")
        set_target_properties(Magic PROPERTIES IMPORTED_LOCATION "${MAGIC_LIBRARIES}")
    endif()
endif()
